...
public class MainActivity extends FragmentActivity {
	...
	// Fragment界面
	private final Class[] fragmentArray = {RecordPage.class,PlayPage.class,ParsePage.class};
	// 选项卡图片
	private final int[] mImageViewArray = {R.drawable.tab_record_icon,R.drawable.tab_play_icon,R.drawable.tab_parse_icon};
	// 选项卡文字
